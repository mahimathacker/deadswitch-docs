...
- **QuadrigaCX** — CEO death locked $240M in customer funds (2019)
- **Stefan Thomas** — forgot password to $200M+ in Bitcoin (ongoing)

Existing solutions like Sarcophagus and Safe Haven pass encrypted keys to heirs, not actual assets. They are treasure maps, not treasure. If the heir does not know how to use a seed phrase, the crypto is still lost.

**DeadSwitch fixes this.**
...
```bash
git clone https://github.com/mahimathacker/DeadSwitch.git
cd deadswitch
forge install
forge build
forge test
...
Built by Mahima Thacker, because your crypto should not die with you.